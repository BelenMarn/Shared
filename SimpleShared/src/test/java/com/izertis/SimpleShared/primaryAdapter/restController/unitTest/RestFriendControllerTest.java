...
import com.izertis.SimpleShared.primaryAdapter.restController.RestFriendController;
...
public class RestFriendControllerTest {
    ...
    public void shouldThrowExceptionWhenFriendNotFound() throws EmptyFriendListException, FriendNotFoundException {
        ...
        //WHEN:
        RuntimeException exception = Assertions.assertThrows(RuntimeException.class, () -> sut.findById(1));
        //THEN:
